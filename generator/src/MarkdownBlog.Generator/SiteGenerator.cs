        ...
        SitePageWriter.WriteHtml(
            ...
            tokens: new Dictionary<string, string>
            {
                ...
                <p data-i18n=""about.blog.intro"">
                    ...
                    Ce blog est justement né de cette envie : explorer, comprendre, tester, prendre du recul… et partager.
                    Tu trouveras ici des articles autour de :
                </p>
                <ul>
                    <li data-i18n=""about.blog.topic1"">la conception et le développement logiciel (.NET, architecture, bonnes pratiques)</li>
                    <li data-i18n=""about.blog.topic2"">le cloud et la performance</li>
                    <li data-i18n=""about.blog.topic3"">les outils et la productivité</li>
                    <li data-i18n=""about.blog.topic4"">l'intelligence artificielle et l'avenir du métier</li>
                    <li data-i18n=""about.blog.topic5"">et parfois, des réflexions plus personnelles sur la tech et le travail</li>
                </ul>
                </div>",
            });
    }   
